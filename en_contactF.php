...
<!-- -->
<div id="pos1">
<b>Thank You : <?php echo $_POST["name"]; ?> <?php echo $_POST["lastname"]; ?> </b><br/>
...
<option value="backgrounds/black_green/index.html">Black Green</option>
<option value="backgrounds/black_orange/index.html">Black Orange</option>
<option value="backgrounds/blue_white/index.html">Blue White</option>
<option value="backgrounds/yellow_black/index.html">Yellow Black</option>
</select>
